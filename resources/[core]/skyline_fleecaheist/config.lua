...
Strings = {
    ...
    ['minute'] = 'minute.',
    ['need_item'] = 'Du brauchst: ',
    ['police_alert'] = 'Fleeca bank robbery alert! Check your gps.',
    ['drill'] = 'Drücke ~INPUT_CONTEXT~ um den Bohrer zu nutzen.',
    ['grab_trolly'] = 'Drücke ~INPUT_CONTEXT~ zum sammeln',
    ['grab'] = 'Drücke ~INPUT_CONTEXT~ zum sammeln',
    ['deliver_to_buyer'] = 'Bringe die Beute zu dem Verkäufer.',
    ['buyer_blip'] = 'Käufer',
    ['need_police'] = 'Not enough police in the city.',
    ['total_money'] = 'Du hast bekommen: '
}
