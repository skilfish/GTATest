...
local laden = {
	...
	{x = 1163.373,  y = -323.801,  z = 68.205},
    {x = -2345.484, y = 3232.572, z = 34.742}
}
...
RegisterNUICallback(
    ...
    function(data, cb)
        ...
        ESX.TriggerServerCallback(
            ...
            function(bool)
                if bool then
                    TriggerEvent("skyline_notify:Alert", "SUPERMARKT" , "Du hast <b style=color:yellow;>" .. withTax .. "$</b> bezahlt." , 4000 , "success")
                else
                    TriggerEvent("skyline_notify:Alert", "SUPERMARKT" , "Du hast nicht genug Geld dabei!" , 4000 , "error")
                end
            end,
            withTax,
            warenkorb
