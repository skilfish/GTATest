            ...
            if craftingQueue[1] ~= nil then
                if not Config.CraftingStopWithDistance or (Config.CraftingStopWithDistance and isNearWorkbench()) then
                    ...
                    if craftingQueue[1].time == 0 then
                        TriggerServerEvent("craftingdukleinerhs:itemCrafted", craftingQueue[1].item, craftingQueue[1].count)
...
RegisterNetEvent("craftingdukleinerhs:craftStart")
AddEventHandler(
    "craftingdukleinerhs:craftStart",
    function(item, count)
...
RegisterNetEvent("craftingdukleinerhs:sendMessage")
AddEventHandler(
    "craftingdukleinerhs:sendMessage",
    function(msg)
        SendTextMessage(msg)
    end
)
...
RegisterNUICallback(
    ...
    function(data)
        ...
        TriggerServerEvent("craftingdukleinerhs:craft", item, false)
    end
)
