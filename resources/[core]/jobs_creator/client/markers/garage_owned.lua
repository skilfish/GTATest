...
local function openPlayerVehicles(markerId)
    TriggerServerCallback(Utils.eventsPrefix .. ':garage_owned:getVehicles', function(vehicles, spawnData)
        ...
        function(data, menu)
            ...
            local vehicle = CreateVehicle(vehicleName, coords, spawnData.heading, true, false)
