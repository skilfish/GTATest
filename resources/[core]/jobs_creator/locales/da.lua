locales['da'] = {
    ...
    ["boss_menu"] = "Boss menu",
    ["boss:society_money"] = "<span style='color:green'>Firma penge: $%s</span>",
    ["boss:withdraw"] = "<span style='color:green'>Hæv firma penge</span>",
    ["boss:deposit"] = "<span style='color:green'>Indsæt firma penge</span>",
    ["boss:wash_money"] = "<span style='color:orange'>Vask penge</span>",
    ["boss:grades"] = "<span style='color:blue'>Administer løninger</span>",
    ["boss:employees"] = "<span style='color:blue'>Administer ansatte</span>",
