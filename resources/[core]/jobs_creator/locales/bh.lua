locales['bh'] = {
    ...
    ["boss:wash_money"] = "<span style='color:orange'>Operi novac</span>",
    ["boss:grades"] = "<span style='color:blue'>Upravljaj platama</span>",
    ["boss:employees"] = "<span style='color:blue'>Upravljaj zaposlenicima</span>",
