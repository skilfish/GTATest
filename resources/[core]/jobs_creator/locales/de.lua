...
locales['de'] = {
    ...
    ['actions:license:give_remove'] = "<span style='color:green'>Give</span>/<span style='color:orange'>Entferne</span> lizenzen",
    ...
    ["wardrobe:delete"] = "%s - <span style='color:orange'>Löschen</span>",
  
  -- [[ Boss Stuff ]]
    ["open_boss"] = "Drücke ~INPUT_CONTEXT~, um das Boss Menü zu öffnen",
    ["not_boss"] = "Du bist kein Boss",
    ["boss_menu"] = "Boss Menü",
    ["boss:society_money"] = "<span style='color:green'>Firmengeld: $%s</span>",
    ["boss:withdraw"] = "<span style='color:green'>Firmengeld abheben</span>",
    ["boss:deposit"] = "<span style='color:green'>Firmengeld einzahlen</span>",
    ["boss:wash_money"] = "<span style='color:orange'>Geld Waschen</span>",
    ["boss:grades"] = "<span style='color:blue'>Verwalte Gehalt</span>",
    ["boss:employees"] = "<span style='color:blue'>Verwalte Mitarbeiter</span>",
    ...
    ["boss:fire"] = "<span style='color:orange'>Feuern</span>",
    ["boss:change_grade"] = "<span style='color:blue'>Befördern/Degradieren</span>",
  ...
  -- [[ Harvest Stuff ]]
    ...
    ['owned_component'] = "%s - <span style='color:green;'>Im Besitz</span>",
