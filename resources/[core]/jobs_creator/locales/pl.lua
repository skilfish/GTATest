locales['pl'] = {
    ...
    ["boss:society_money"] = "<span style='color:green'>Saldo konta: $%s</span>",
    ["boss:withdraw"] = "<span style='color:green'>Wypłać z salda konta</span>",
    ["boss:deposit"] = "<span style='color:green'>Wypłać pięniądze z salda</span>",
    ["boss:wash_money"] = "<span style='color:orange'>Wypierz pieniądze</span>",
    ["boss:grades"] = "<span style='color:blue'>Zarządzaj wypłatami rang</span>",
    ["boss:employees"] = "<span style='color:blue'>Zarządzaj pracownikami</span>",
