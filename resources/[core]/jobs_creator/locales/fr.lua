locales['fr'] = {
    ...
    ["boss:deposit"] = "<span style='color:green'>Dépôt de l'argent de la société</span>",
    ["boss:wash_money"] = "<span style='color:red'>Laver de l'argent</span>",
    ["boss:grades"] = "<span style='color:blue'>Gérer les salaires des grades</span>",
