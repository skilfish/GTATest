locales['pt'] = {
    ...
    ["boss:society_money"] = "<span style='color:green'>Dinheiro da sociedade: €%s</span>",
    ["boss:withdraw"] = "<span style='color:green'>Retirar dinheiro da sociedade</span>",
    ["boss:deposit"] = "<span style='color:green'>Depositar dinheiro da sociedade</span>",
    ["boss:wash_money"] = "<span style='color:orange'>Lavar dinheiro</span>",
    ["boss:grades"] = "<span style='color:blue'>Gerenciar salarios</span>",
    ["boss:employees"] = "<span style='color:blue'>Gerenciar empregados</span>",
