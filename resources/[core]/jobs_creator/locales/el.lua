locales['el'] = {
    ...
    ["boss_menu"] = "Boss menu",
    ["boss:society_money"] = "<span style='color:green'>Λεφτα Επιχείρησης: €%s</span>",
    ["boss:withdraw"] = "<span style='color:green'>Βγάλε χρήματα από την επιχείρηση</span>",
    ["boss:deposit"] = "<span style='color:green'>Κατάθεση χρημάτων στην επιχείρηση</span>",
    ["boss:wash_money"] = "<span style='color:orange'>Πλύνετε χρήματα</span>",
    ["boss:grades"] = "<span style='color:blue'>Διαχειριστείτε τους μισθούς βαθμών</span>",
    ["boss:employees"] = "<span style='color:blue'>Διαχειριστείτε τους υπαλλήλους</span>",
