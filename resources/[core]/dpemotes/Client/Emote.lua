...
Citizen.CreateThread(function()
    TriggerEvent('chat:addSuggestion', '/e', 'Ein Emote machen', {{ name="emotename", help="Name des Emotes."}})
    TriggerEvent('chat:addSuggestion', '/e', 'Ein Emote machen', {{ name="emotename", help="Name des Emotes."}})
    TriggerEvent('chat:addSuggestion', '/emote', 'Ein Emote machen', {{ name="emotename", help="Name des Emotes."}})
    if Config.SqlKeybinding then
      TriggerEvent('chat:addSuggestion', '/emotebind', 'Ein Hotkey erstellen, für ein Emote', {{ name="key", help="num4, num5, num6, num7. num8, num9. Numpad 4-9!"}, { name="emotename", help="Name des Emotes."}})
      TriggerEvent('chat:addSuggestion', '/emotebinds', 'Schaue welche Hotkeys du aktuell hast')
    end
