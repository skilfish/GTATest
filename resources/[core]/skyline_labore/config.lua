...
Config = {
  ...
  SetJobEvent       = 'skyline:setJob',   -- Probably don't change this if you're using ESX.
  SetJob2Event      = 'skyline:setJob2',  -- If youre using job2...

  UsingItemLimit    = false,  -- if using esx item limits
  UsingWeightLimit  = true, -- if using esx item weight

  SqlSaveTimer      = 2, -- minutes for zone influence to save to database
  ...
  GangJobs = {                        -- List all jobs that are able to contest for and control territories here.
    ...
    "mg13",
    "vagos",
    "aztecas"                      -- NOTE: Don't need to include police. Thats taken from PoliceJob var above,
  }
}
...
Territories = {
 --[[ ["Sägewerk"] = {
    control = "abou_chaker",                                   -- The default control for this zone belongs to this job.
    influence = 100.0,                                    -- The default influence for this zone.
    zone = "MTCHIL",                                      -- Probably don't change this unless you intend on moving the zones around.
    ...
    areas = {                                             -- Areas are responsible for the large square blips on the map.
      [1] = { 
        location  = vector3(-565.60345458984, 5325.6801757813,73.587600708008),
        width     = 350.0,
        height    = 200.0,
        heading   = 60,
        display   = 10
    ...
    blipData = {                                          -- BlipData is responsible for the blip corresponding to the entry action of this zone.
      pos = vector3(-565.60345458984, 5325.6801757813,73.587600708008),
      sprite = 500,
      color = 1,
 ...
 --[[ ["Davis"] = {
  ...
  ["PBLUFF"] = {
    ...
    areas = {
      [1] = {
        location  = vector3(-2196.9853515625,237.86825561523, 174.6018371582),
        width     = 200.0,
        height    = 280.0,
        heading   = 50,
        display   = 4
    ...
    blipData = {
      pos = vector3(-2196.9853515625,237.86825561523, 174.6018371582),
      sprite = 499,
      color = 3,
