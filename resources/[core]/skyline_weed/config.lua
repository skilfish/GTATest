Config = {
    ...
    Items = { -- What items are used?
        ...
        Tend = "wasser",             -- Optional item to progress growth cycle
    ...
    Yield = {1,5}, -- How many Items.Product does each plant yield? {5,10} means "from 5 to 10, inclusive"
    YieldSeed = {0,1}, -- Same as Yield, except for the amount of seeds you get back
    TimeMultiplier = 0.2, -- Multiplier for the growth/tend times
    Soil = {
