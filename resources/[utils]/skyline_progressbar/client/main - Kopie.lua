            ...
            Citizen.CreateThread(function ()
                while isDoingAction do
                    ...
                    if IsControlJustPressed(0, 178) and mythic_action.canCancel then
                        TriggerEvent("skyline_progressbar:client:cancel")
                    end
                end
                if finish ~= nil then
                    finish(wasCancelled)
...
RegisterNetEvent("skyline_progressbar:client:progress")
AddEventHandler("skyline_progressbar:client:progress", function(action, finish)
    Progress(action, finish)
end)

RegisterNetEvent("skyline_progressbar:client:ProgressWithStartEvent")
AddEventHandler("skyline_progressbar:client:ProgressWithStartEvent", function(action, start, finish)
    ProgressWithStartEvent(action, start, finish)
end)

RegisterNetEvent("skyline_progressbar:client:ProgressWithTickEvent")
AddEventHandler("skyline_progressbar:client:ProgressWithTickEvent", function(action, tick, finish)
    ProgressWithTickEvent(action, tick, finish)
end)

RegisterNetEvent("skyline_progressbar:client:ProgressWithStartAndTick")
AddEventHandler("skyline_progressbar:client:ProgressWithStartAndTick", function(action, start, tick, finish)
    ProgressWithStartAndTick(action, start, tick, finish)
end)

RegisterNetEvent("skyline_progressbar:client:cancel")
AddEventHandler("skyline_progressbar:client:cancel", function()
    isDoingAction = false
    wasCancelled = true

    TriggerEvent("skyline_progressbar:client:actionCleanup")
...
RegisterNetEvent("skyline_progressbar:client:actionCleanup")
AddEventHandler("skyline_progressbar:client:actionCleanup", function()
